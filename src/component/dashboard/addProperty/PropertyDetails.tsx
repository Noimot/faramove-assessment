    ...
    <div>
      ...
      >
        <Button
          ...
          className="capitalize bg-klooft-red w-335 h-50 tracking-05 text-white text-base font-Gilroy-semibold rounded-lg disabled:opacity-75 disabled:cursor-not-allowed"
        />
      </div>
    </div>
  );
